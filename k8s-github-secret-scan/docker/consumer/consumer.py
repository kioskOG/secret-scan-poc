...
recipient_email = [
        {'name': 'xxxxxxxxxx', 'email': 'xxxxxxxx@gmail.com'}
    ]

sender_email = "xxxxxxxxx@gmail.com".strip()
password = "xxxxxxxxxxx".strip()  # https://myaccount.google.com/apppasswords
...
def consumer_group():
    try:
        consumer = KafkaConsumer(
            ...
            bootstrap_servers=['kafka.secret-scan.svc.cluster.local:9092'],
